...
# Original Author: AlexChaplinBraz <https://github.com/AlexChaplinBraz/dmenu-scripts>

# Set a character width for this script if needed:
#export MANWIDTH=80
TERMINAL="${TERMINAL:-st}"

sel=$(apropos --long . | dmenu -i -l 30 -p "Man Pages :" | awk '{print $2, $1}' | tr -d '()')
[[ ! -z $sel ]] && $TERMINAL -e man $sel
